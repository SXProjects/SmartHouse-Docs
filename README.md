...
На сервере необходимо добавить time и device_id, если устройство вызовет transmit_data и только после этого передать на сеть вещей. Устройство информирует о изменениях с помощью POST запроса.
